...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        self.nameLabel = [[UILabel alloc] initWithFrame: CGRectMake(4, 17, [self frame].size.width - 8, 20)];
        ...
        self.additionalFieldHint = [[UILabel alloc] initWithFrame: CGRectMake(4, 40, [self frame].size.width - 8, 20)];
        ...
        self.additionalField = [[UITextField alloc] initWithFrame: CGRectMake(4, 64, [self frame].size.width - 8, 30)];
        ...
        self.optionalNoticeLabel = [[UILabel alloc] initWithFrame: CGRectMake(4, 100, [self frame].size.width - 8, 30)];
...
- (void)setActive:(BOOL)a{
    ...
    if(active){
        [nameLabel setFrame: CGRectMake(4, 8, [self frame].size.width - 8, 20)];
        [additionalFieldHint setAlpha: 1.0f];
        [additionalField setAlpha: 1.0f];
    }else{
        [nameLabel setFrame: CGRectMake(4, 17, [self frame].size.width - 8, 20)];
        [additionalFieldHint setAlpha: 0.0f];
        [additionalField setAlpha: 0.0f];
    }
...
- (void)setOptionalNoticeText:(NSString *)text{
    CGSize requiredSize = [text sizeWithFont:[UIFont fontWithName:@"OpenSans" size:18] constrainedToSize:CGSizeMake([self frame].size.width - 8, INFINITY)];
    [optionalNoticeLabel setFrame: CGRectMake(4, 100, [self frame].size.width - 8, requiredSize.height)];
