...
//#define RSU_ENTRY_POINT_SERVER_URL  @"http://localhost/Races"

// Testing Entry Point: jk local: 10.1.10.68
//#define RSU_DOMAIN  @"10.1.10.68"
//#define RSU_ENTRY_POINT_SERVER_URL  @"http://10.1.10.68/Races"
//#define RSU_ENTRY_POINT_SERVER_URL  @"http://172.20.20.20/Races"

// Testing Entry Point: jk home local: 10.0.0.21
//#define RSU_DOMAIN  @"10.0.0.21"
//#define RSU_ENTRY_POINT_SERVER_URL  @"http://10.0.0.21/Races"

// Testing Entry Point: local: hosts file redirects test.runsignup.com to 10.1.10.68
//#define RSU_DOMAIN  @"test.runsignup.com"
//#define RSU_ENTRY_POINT_SERVER_URL  @"http://test.runsignup.com/Races"
